 ...
 *   0.00–0.10  portrait, still
 *   0.10–0.38  head pitches back — face still coherent
 *   0.18–0.44  skin resolves into topographic contour lines
 *   0.32–0.64  face disintegrates; particles morph to the nerve cloud
 *   0.30–0.68  filaments grow out from the head
 *   0.62–0.86  everything settles: particles fade to faint debris, strands lead
 */
